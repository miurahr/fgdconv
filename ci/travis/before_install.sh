...
sudo chroot "$chroot" apt-get update
sudo chroot "$chroot" apt-get install -y libxml2-dev libgdal-dev python2.7 python2.7-dev python-pip python-pip-whl python3 python3-wheel build-essential python3-pip python3.5-dev python-virtualenv python3-virtualenv git
# libgdal-dev 2.1.0
